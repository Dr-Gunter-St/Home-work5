...
public class BookingComAPI implements API{
    ...
    public BookingComAPI(){
        ...
        this.rooms[0] = new Room(1000, 3, "Washington", "Empire");
        this.rooms[1] = new Room(500, 1, "Los Angeles", "California");
        this.rooms[2] = new Room(750, 2, "Pasadena", "Cloud9");
        this.rooms[3] = new Room(1500, 4, "New York", "Continental");
        this.rooms[4] = new Room(900, 3, "Miami", "Titan");
