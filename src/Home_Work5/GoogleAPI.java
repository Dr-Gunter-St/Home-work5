...
public class GoogleAPI implements API{
    ...
    public GoogleAPI() {
        ...
        this.rooms[0] = new Room(1200, 3, "Washington", "Empire");
        this.rooms[1] = new Room(600, 1, "Los Angeles", "California");
        this.rooms[2] = new Room(650, 2, "Pasadena", "Cloud9");
        this.rooms[3] = new Room(1700, 4, "New York", "Continental");
        this.rooms[4] = new Room(800, 3, "Miami", "Titan");
    }
